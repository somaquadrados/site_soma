# ---------------------------------------------------------------------------- #
# Introducción al análisis de datos biológicos con R - Reviso
#
...
# Help > keyboard shortcuts help (atajos)

# Tools > Global options > appearance (cambiar la estética)
...
# !! obs: 
#  La pestaña "Environmental" de RStudio muestra los objetos creados
#  hasta ahora en la sesión actual (🡥). 

#  Es posible cambiar el modo de visualización de los objetos y seleccionar 
#  cuáles serán excluidos y cuáles no.
